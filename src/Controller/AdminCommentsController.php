...
class AdminCommentsController extends AbstractController
{
    ...
    public function new(Request $request, CommentsRepository $commentsRepository): Response
    {
        ...
        return $this->renderForm('admin_comments/new.html.twig', [
            'comment' => $comment,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_comments/show.html.twig', [
            'comment' => $comment,
        ]);
    }
    ...
    public function edit(Request $request, Comments $comment, CommentsRepository $commentsRepository): Response
    {
        ...
        return $this->renderForm('admin_comments/edit.html.twig', [
            'comment' => $comment,
            'form' => $form,
        ]);
    }
